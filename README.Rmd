...
> **Precision note:** `as_mlx()` always stores data in `float32`. Requests for `dtype = "float64"` are downcast with a warning. Use base R arrays if you require double precision arithmetic.
