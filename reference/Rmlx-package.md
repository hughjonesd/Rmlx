...
prefix, but it also ships [S3 methods for many base
generics](https://hughjonesd.github.io/Rmlx/reference/mlx-methods.md),
so common R matrix operations continue to work on MLX arrays. R
conventions are used throughout: for example, indexing is 1-based.
