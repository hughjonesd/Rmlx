...
Input has shape `(N, D, H, W, C_in)` where N is batch size, D, H, W are
depth, height and width, and C_in is number of input channels. Weight
has shape `(C_out, kernel_d, kernel_h, kernel_w, C_in)`.

## See also

[mlx.core.conv3d](https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.conv3d.html)
