...
#> Compiled closed-form ||w - w*|| = 0.09404489
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.37s |          0.0941 |
| MLX closed form            |     47.24ms |          0.0940 |
| MLX closed form (compiled) |     46.78ms |          0.0940 |
| Base R                     |     61.74ms |          0.0940 |
