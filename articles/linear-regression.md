...
#> Compiled closed-form ||w - w*|| = 0.1009398
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        2.3s |          0.1010 |
| MLX closed form            |      44.3ms |          0.1009 |
| MLX closed form (compiled) |      44.5ms |          0.1009 |
| Base R                     |      33.5ms |          0.1009 |
