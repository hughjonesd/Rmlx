...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.045004e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001128754
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.75s |          0.0012 |
| MLX closed form            |     26.26ms |          0.0011 |
| MLX closed form (compiled) |     31.54ms |          0.0011 |
| Base R                     |     35.54ms |          0.0011 |
