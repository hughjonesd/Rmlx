...
#> Compiled closed-form ||w - w*|| = 0.08963381
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.28s |          0.0897 |
| MLX closed form            |     27.97ms |          0.0896 |
| MLX closed form (compiled) |     30.12ms |          0.0896 |
| Base R                     |     32.61ms |          0.0896 |
