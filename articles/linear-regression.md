...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.976551e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001045771
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.46s |           0.001 |
| MLX closed form            |     22.34ms |           0.001 |
| MLX closed form (compiled) |      22.1ms |           0.001 |
| Base R                     |     31.82ms |           0.001 |
