...
#> Compiled closed-form ||w - w*|| = 0.1150735
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.58s |          0.1151 |
| MLX closed form            |     18.79ms |          0.1151 |
| MLX closed form (compiled) |      16.9ms |          0.1151 |
| Base R                     |     38.48ms |          0.1151 |
