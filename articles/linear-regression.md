...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.012835e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.000942284
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.41s |           1e-03 |
| MLX closed form            |     29.02ms |           9e-04 |
| MLX closed form (compiled) |     20.84ms |           9e-04 |
| Base R                     |     35.25ms |           9e-04 |
