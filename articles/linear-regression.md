...
#> Compiled closed-form ||w - w*|| = 0.0883837
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.33s |          0.0884 |
| MLX closed form            |     20.14ms |          0.0884 |
| MLX closed form (compiled) |     18.62ms |          0.0884 |
| Base R                     |     35.88ms |          0.0884 |
