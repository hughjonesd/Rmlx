...
#> Compiled closed-form ||w - w*|| = 0.1032157
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.96s |          0.1032 |
| MLX closed form            |     22.55ms |          0.1032 |
| MLX closed form (compiled) |     20.05ms |          0.1032 |
| Base R                     |     92.89ms |          0.1032 |
