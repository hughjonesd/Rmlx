...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.90827e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0009502892
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       4.37s |           0.001 |
| MLX closed form            |     39.79ms |           0.001 |
| MLX closed form (compiled) |     35.04ms |           0.001 |
| Base R                     |      56.3ms |           0.001 |
