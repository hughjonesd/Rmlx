...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.051483e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0008773299
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.65s |           9e-04 |
| MLX closed form            |     36.77ms |           9e-04 |
| MLX closed form (compiled) |     38.62ms |           9e-04 |
| Base R                     |     64.07ms |           9e-04 |
