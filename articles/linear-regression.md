...
#> Compiled closed-form ||w - w*|| = 0.08007613
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.72s |          0.0801 |
| MLX closed form            |     32.15ms |          0.0801 |
| MLX closed form (compiled) |     18.28ms |          0.0801 |
| Base R                     |     37.95ms |          0.0801 |
