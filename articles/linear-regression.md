...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.090393e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001089213
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.04s |          0.0011 |
| MLX closed form            |     34.93ms |          0.0011 |
| MLX closed form (compiled) |     28.19ms |          0.0011 |
| Base R                     |     40.51ms |          0.0011 |
