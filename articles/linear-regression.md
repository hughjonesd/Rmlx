...
#> Compiled closed-form ||w - w*|| = 0.09197222
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        3.4s |           0.092 |
| MLX closed form            |      41.2ms |           0.092 |
| MLX closed form (compiled) |      42.1ms |           0.092 |
| Base R                     |      91.8ms |           0.092 |
