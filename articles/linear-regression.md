...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.030111e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001071843
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.97s |          0.0011 |
| MLX closed form            |     21.52ms |          0.0011 |
| MLX closed form (compiled) |     20.56ms |          0.0011 |
| Base R                     |     33.27ms |          0.0011 |
