...
#> Compiled closed-form ||w - w*|| = 0.1056848
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.31s |          0.1057 |
| MLX closed form            |     34.72ms |          0.1057 |
| MLX closed form (compiled) |     37.75ms |          0.1057 |
| Base R                     |    109.02ms |          0.1057 |
