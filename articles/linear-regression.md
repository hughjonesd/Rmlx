...
#> Compiled closed-form ||w - w*|| = 0.0801836
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.77s |          0.0802 |
| MLX closed form            |     20.68ms |          0.0802 |
| MLX closed form (compiled) |     18.17ms |          0.0802 |
| Base R                     |    103.19ms |          0.0802 |
