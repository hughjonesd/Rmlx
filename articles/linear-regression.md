...
#> Compiled closed-form ||w - w*|| = 0.1016637
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.46s |          0.1017 |
| MLX closed form            |     20.63ms |          0.1017 |
| MLX closed form (compiled) |     20.27ms |          0.1017 |
| Base R                     |     31.63ms |          0.1017 |
