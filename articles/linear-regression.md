...
#> Compiled closed-form ||w - w*|| = 0.1013322
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.99s |          0.1013 |
| MLX closed form            |     45.01ms |          0.1013 |
| MLX closed form (compiled) |     38.05ms |          0.1013 |
| Base R                     |     30.72ms |          0.1013 |
