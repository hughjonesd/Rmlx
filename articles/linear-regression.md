...
#> Compiled closed-form ||w - w*|| = 0.1005215
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.83s |          0.1006 |
| MLX closed form            |     45.81ms |          0.1005 |
| MLX closed form (compiled) |      43.6ms |          0.1005 |
| Base R                     |     93.04ms |          0.1005 |
