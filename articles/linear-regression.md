...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.141915e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0009178295
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.12s |           9e-04 |
| MLX closed form            |     36.33ms |           9e-04 |
| MLX closed form (compiled) |     27.22ms |           9e-04 |
| Base R                     |      48.7ms |           9e-04 |
