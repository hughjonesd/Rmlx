...
#> Compiled closed-form ||w - w*|| = 0.08919262
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.76s |          0.0892 |
| MLX closed form            |     39.92ms |          0.0892 |
| MLX closed form (compiled) |     40.57ms |          0.0892 |
| Base R                     |     44.67ms |          0.0892 |
