...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.97035e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001045633
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.12s |          0.0011 |
| MLX closed form            |        21ms |          0.0010 |
| MLX closed form (compiled) |     19.39ms |          0.0010 |
| Base R                     |     29.25ms |          0.0010 |
