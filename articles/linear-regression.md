...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.948907e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0009450886
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.05s |           1e-03 |
| MLX closed form            |     51.92ms |           9e-04 |
| MLX closed form (compiled) |     60.12ms |           9e-04 |
| Base R                     |     49.67ms |           9e-04 |
