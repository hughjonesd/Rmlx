...
#> Compiled closed-form ||w - w*|| = 0.09985434
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.97s |          0.0998 |
| MLX closed form            |     44.08ms |          0.0999 |
| MLX closed form (compiled) |     53.76ms |          0.0999 |
| Base R                     |     50.96ms |          0.0999 |
