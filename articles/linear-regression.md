...
#> Compiled closed-form ||w - w*|| = 0.09263861
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.24s |          0.0926 |
| MLX closed form            |     21.48ms |          0.0926 |
| MLX closed form (compiled) |     19.37ms |          0.0926 |
| Base R                     |     87.99ms |          0.0926 |
