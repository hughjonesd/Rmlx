...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.88832e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001002335
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        1.9s |           0.001 |
| MLX closed form            |      37.3ms |           0.001 |
| MLX closed form (compiled) |      38.4ms |           0.001 |
| Base R                     |        35ms |           0.001 |
