...
#> Compiled closed-form ||w - w*|| = 0.09894545
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.27s |          0.0990 |
| MLX closed form            |     25.17ms |          0.0989 |
| MLX closed form (compiled) |     19.77ms |          0.0989 |
| Base R                     |     32.58ms |          0.0989 |
