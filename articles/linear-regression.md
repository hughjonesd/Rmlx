...
#> Compiled closed-form ||w - w*|| = 0.1040873
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.99s |          0.1041 |
| MLX closed form            |     20.56ms |          0.1041 |
| MLX closed form (compiled) |     19.57ms |          0.1041 |
| Base R                     |     31.32ms |          0.1041 |
