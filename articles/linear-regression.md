...
#> Compiled closed-form ||w - w*|| = 0.1018169
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.41s |          0.1018 |
| MLX closed form            |     21.61ms |          0.1018 |
| MLX closed form (compiled) |     43.71ms |          0.1018 |
| Base R                     |     91.35ms |          0.1018 |
