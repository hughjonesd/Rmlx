...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.955475e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0008998314
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.97s |           9e-04 |
| MLX closed form            |     35.97ms |           9e-04 |
| MLX closed form (compiled) |     30.06ms |           9e-04 |
| Base R                     |     43.64ms |           9e-04 |
