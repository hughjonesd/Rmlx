...
#> Compiled closed-form ||w - w*|| = 0.09623094
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.36s |          0.0962 |
| MLX closed form            |     20.89ms |          0.0962 |
| MLX closed form (compiled) |     17.43ms |          0.0962 |
| Base R                     |     33.25ms |          0.0962 |
