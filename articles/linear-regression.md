...
#> Compiled closed-form ||w - w*|| = 0.1023152
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.72s |          0.1023 |
| MLX closed form            |     21.29ms |          0.1023 |
| MLX closed form (compiled) |     19.09ms |          0.1023 |
| Base R                     |     91.16ms |          0.1023 |
