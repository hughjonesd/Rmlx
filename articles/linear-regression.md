...
#> Compiled closed-form ||w - w*|| = 0.112623
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        2.8s |          0.1126 |
| MLX closed form            |      21.5ms |          0.1126 |
| MLX closed form (compiled) |      17.4ms |          0.1126 |
| Base R                     |      88.9ms |          0.1126 |
