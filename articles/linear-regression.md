...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.0589e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0009406764
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.73s |           1e-03 |
| MLX closed form            |     22.69ms |           9e-04 |
| MLX closed form (compiled) |     21.23ms |           9e-04 |
| Base R                     |     33.18ms |           9e-04 |
