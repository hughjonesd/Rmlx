...
#> Compiled closed-form ||w - w*|| = 0.08493084
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       4.36s |          0.0849 |
| MLX closed form            |     44.95ms |          0.0849 |
| MLX closed form (compiled) |     42.16ms |          0.0849 |
| Base R                     |     42.53ms |          0.0849 |
