...
#> Compiled closed-form ||w - w*|| = 0.1062787
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.46s |          0.1063 |
| MLX closed form            |     28.12ms |          0.1063 |
| MLX closed form (compiled) |     17.05ms |          0.1063 |
| Base R                     |     43.09ms |          0.1063 |
