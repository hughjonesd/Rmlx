...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.990586e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001096024
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.01s |          0.0011 |
| MLX closed form            |     50.28ms |          0.0011 |
| MLX closed form (compiled) |     43.48ms |          0.0011 |
| Base R                     |     34.06ms |          0.0011 |
