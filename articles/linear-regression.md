...
#> Compiled closed-form ||w - w*|| = 0.09991872
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.76s |          0.0999 |
| MLX closed form            |     39.61ms |          0.0999 |
| MLX closed form (compiled) |     33.94ms |          0.0999 |
| Base R                     |     39.82ms |          0.0999 |
