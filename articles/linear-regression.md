...
#> Compiled closed-form ||w - w*|| = 0.1026451
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        2.6s |          0.1027 |
| MLX closed form            |      30.4ms |          0.1026 |
| MLX closed form (compiled) |      21.4ms |          0.1026 |
| Base R                     |      33.1ms |          0.1026 |
