...
#> Compiled closed-form ||w - w*|| = 0.1010477
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.88s |          0.1011 |
| MLX closed form            |      24.6ms |          0.1010 |
| MLX closed form (compiled) |     25.54ms |          0.1010 |
| Base R                     |     38.91ms |          0.1010 |
