...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.007624e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0009751467
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.73s |           0.001 |
| MLX closed form            |     22.87ms |           0.001 |
| MLX closed form (compiled) |     19.94ms |           0.001 |
| Base R                     |     30.28ms |           0.001 |
