...
#> Compiled closed-form ||w - w*|| = 0.09218349
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.72s |          0.0922 |
| MLX closed form            |     28.76ms |          0.0922 |
| MLX closed form (compiled) |     26.08ms |          0.0922 |
| Base R                     |     33.82ms |          0.0922 |
