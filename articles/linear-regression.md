...
#> Compiled closed-form ||w - w*|| = 0.1012459
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.02s |          0.1012 |
| MLX closed form            |     26.59ms |          0.1012 |
| MLX closed form (compiled) |     22.44ms |          0.1012 |
| Base R                     |      45.4ms |          0.1012 |
