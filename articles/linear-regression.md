...
#> Compiled closed-form ||w - w*|| = 0.1078399
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.43s |          0.1079 |
| MLX closed form            |     27.15ms |          0.1078 |
| MLX closed form (compiled) |     23.37ms |          0.1078 |
| Base R                     |     37.65ms |          0.1078 |
