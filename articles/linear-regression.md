...
#> Compiled closed-form ||w - w*|| = 0.1042858
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.05s |          0.1043 |
| MLX closed form            |     35.73ms |          0.1043 |
| MLX closed form (compiled) |      41.7ms |          0.1043 |
| Base R                     |     49.87ms |          0.1043 |
