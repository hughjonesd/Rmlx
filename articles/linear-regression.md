...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.855885e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0009378282
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.67s |           9e-04 |
| MLX closed form            |      19.3ms |           9e-04 |
| MLX closed form (compiled) |     20.51ms |           9e-04 |
| Base R                     |        30ms |           9e-04 |
