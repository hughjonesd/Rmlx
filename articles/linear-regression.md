...
#> Compiled closed-form ||w - w*|| = 0.0991612
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.89s |          0.0991 |
| MLX closed form            |     22.15ms |          0.0992 |
| MLX closed form (compiled) |     21.14ms |          0.0992 |
| Base R                     |     30.71ms |          0.0992 |
