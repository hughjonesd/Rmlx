...
#> Compiled closed-form ||w - w*|| = 0.09846059
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.18s |          0.0985 |
| MLX closed form            |     34.28ms |          0.0985 |
| MLX closed form (compiled) |     31.34ms |          0.0985 |
| Base R                     |    108.24ms |          0.0985 |
