...
#> Compiled closed-form ||w - w*|| = 0.1011834
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        1.6s |          0.1012 |
| MLX closed form            |      24.4ms |          0.1012 |
| MLX closed form (compiled) |      23.3ms |          0.1012 |
| Base R                     |        34ms |          0.1012 |
