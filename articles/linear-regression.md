...
#> Compiled closed-form ||w - w*|| = 0.1110031
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.65s |           0.111 |
| MLX closed form            |     23.03ms |           0.111 |
| MLX closed form (compiled) |      21.2ms |           0.111 |
| Base R                     |     32.76ms |           0.111 |
