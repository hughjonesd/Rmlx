...
#> Compiled closed-form ||w - w*|| = 0.0946471
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.95s |          0.0946 |
| MLX closed form            |     19.32ms |          0.0946 |
| MLX closed form (compiled) |     18.44ms |          0.0946 |
| Base R                     |     35.56ms |          0.0946 |
