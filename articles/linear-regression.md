...
#> Compiled closed-form ||w - w*|| = 0.1113955
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.83s |          0.1114 |
| MLX closed form            |     22.89ms |          0.1114 |
| MLX closed form (compiled) |     27.34ms |          0.1114 |
| Base R                     |     37.97ms |          0.1114 |
