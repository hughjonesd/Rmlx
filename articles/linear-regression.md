...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.022158e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0009356077
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.46s |           9e-04 |
| MLX closed form            |     46.03ms |           9e-04 |
| MLX closed form (compiled) |      44.2ms |           9e-04 |
| Base R                     |      33.7ms |           9e-04 |
