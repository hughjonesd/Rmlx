...
#> Compiled closed-form ||w - w*|| = 0.1190044
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.81s |           0.119 |
| MLX closed form            |     25.76ms |           0.119 |
| MLX closed form (compiled) |     22.39ms |           0.119 |
| Base R                     |     33.04ms |           0.119 |
