...
#> Compiled closed-form ||w - w*|| = 0.08946512
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.79s |          0.0894 |
| MLX closed form            |      36.4ms |          0.0895 |
| MLX closed form (compiled) |     42.16ms |          0.0895 |
| Base R                     |    114.12ms |          0.0895 |
