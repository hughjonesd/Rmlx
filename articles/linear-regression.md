...
#> Compiled closed-form ||w - w*|| = 0.09859569
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.46s |          0.0986 |
| MLX closed form            |     22.36ms |          0.0986 |
| MLX closed form (compiled) |     19.66ms |          0.0986 |
| Base R                     |     30.78ms |          0.0986 |
