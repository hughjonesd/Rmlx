...
#> Compiled closed-form ||w - w*|| = 0.1041469
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        2.2s |          0.1041 |
| MLX closed form            |      20.8ms |          0.1041 |
| MLX closed form (compiled) |      19.5ms |          0.1041 |
| Base R                     |      29.3ms |          0.1041 |
