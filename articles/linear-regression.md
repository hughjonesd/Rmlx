...
#> Compiled closed-form ||w - w*|| = 0.101853
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.72s |          0.1019 |
| MLX closed form            |     23.51ms |          0.1019 |
| MLX closed form (compiled) |     19.25ms |          0.1019 |
| Base R                     |     85.81ms |          0.1019 |
