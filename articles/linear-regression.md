...
#> Compiled closed-form ||w - w*|| = 0.1015042
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.94s |          0.1015 |
| MLX closed form            |     41.49ms |          0.1015 |
| MLX closed form (compiled) |     44.09ms |          0.1015 |
| Base R                     |     58.43ms |          0.1015 |
