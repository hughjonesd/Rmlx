...
#> Compiled closed-form ||w - w*|| = 0.09594236
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.74s |          0.0959 |
| MLX closed form            |     22.55ms |          0.0959 |
| MLX closed form (compiled) |     21.08ms |          0.0959 |
| Base R                     |     30.35ms |          0.0959 |
