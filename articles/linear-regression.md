...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.01488e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001075885
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        2.8s |          0.0011 |
| MLX closed form            |      48.6ms |          0.0011 |
| MLX closed form (compiled) |      49.2ms |          0.0011 |
| Base R                     |      32.6ms |          0.0011 |
