...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.918933e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001050639
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.87s |          0.0011 |
| MLX closed form            |     20.69ms |          0.0011 |
| MLX closed form (compiled) |     19.24ms |          0.0011 |
| Base R                     |     28.66ms |          0.0011 |
