...
#> Compiled closed-form ||w - w*|| = 0.09193564
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.34s |          0.0919 |
| MLX closed form            |     22.11ms |          0.0919 |
| MLX closed form (compiled) |     21.52ms |          0.0919 |
| Base R                     |     31.69ms |          0.0919 |
