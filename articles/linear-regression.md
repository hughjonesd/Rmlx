...
#> Compiled closed-form ||w - w*|| = 0.1043379
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.86s |          0.1043 |
| MLX closed form            |        20ms |          0.1043 |
| MLX closed form (compiled) |     19.73ms |          0.1043 |
| Base R                     |     91.59ms |          0.1043 |
