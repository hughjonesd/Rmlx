...
#> Compiled closed-form ||w - w*|| = 0.1219961
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.07s |           0.122 |
| MLX closed form            |     57.33ms |           0.122 |
| MLX closed form (compiled) |     57.77ms |           0.122 |
| Base R                     |      50.3ms |           0.122 |
