...
#> Compiled closed-form ||w - w*|| = 0.09222844
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.46s |          0.0922 |
| MLX closed form            |     43.15ms |          0.0922 |
| MLX closed form (compiled) |      45.8ms |          0.0922 |
| Base R                     |     34.23ms |          0.0922 |
