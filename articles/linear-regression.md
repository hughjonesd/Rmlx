...
#> Compiled closed-form ||w - w*|| = 0.1030511
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.87s |          0.1030 |
| MLX closed form            |     53.98ms |          0.1031 |
| MLX closed form (compiled) |      59.2ms |          0.1031 |
| Base R                     |     42.98ms |          0.1031 |
