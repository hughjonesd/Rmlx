...
#> Compiled closed-form ||w - w*|| = 0.09909081
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.16s |          0.0991 |
| MLX closed form            |     27.43ms |          0.0991 |
| MLX closed form (compiled) |     24.78ms |          0.0991 |
| Base R                     |     67.17ms |          0.0991 |
