...
#> Compiled closed-form ||w - w*|| = 0.09705976
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.99s |          0.0971 |
| MLX closed form            |     20.93ms |          0.0971 |
| MLX closed form (compiled) |     19.57ms |          0.0971 |
| Base R                     |      81.1ms |          0.0971 |
