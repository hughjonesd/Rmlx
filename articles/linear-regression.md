...
#> Compiled closed-form ||w - w*|| = 0.0953351
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.28s |          0.0953 |
| MLX closed form            |     20.66ms |          0.0953 |
| MLX closed form (compiled) |     19.79ms |          0.0953 |
| Base R                     |     34.28ms |          0.0953 |
