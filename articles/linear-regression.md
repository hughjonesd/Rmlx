...
#> Compiled closed-form ||w - w*|| = 0.1019486
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.39s |          0.1019 |
| MLX closed form            |     48.94ms |          0.1019 |
| MLX closed form (compiled) |     51.57ms |          0.1019 |
| Base R                     |     48.06ms |          0.1019 |
