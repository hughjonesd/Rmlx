...
#> Compiled closed-form ||w - w*|| = 0.095282
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.33s |          0.0953 |
| MLX closed form            |      33.4ms |          0.0953 |
| MLX closed form (compiled) |     31.21ms |          0.0953 |
| Base R                     |     44.83ms |          0.0953 |
