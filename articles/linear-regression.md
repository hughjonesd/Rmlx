...
#> Compiled closed-form ||w - w*|| = 0.1045531
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.06s |          0.1046 |
| MLX closed form            |     38.13ms |          0.1046 |
| MLX closed form (compiled) |     37.78ms |          0.1046 |
| Base R                     |     57.96ms |          0.1046 |
