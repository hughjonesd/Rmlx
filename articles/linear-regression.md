...
#> Compiled closed-form ||w - w*|| = 0.109168
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       3.85s |          0.1092 |
| MLX closed form            |     39.63ms |          0.1092 |
| MLX closed form (compiled) |     35.73ms |          0.1092 |
| Base R                     |       105ms |          0.1092 |
