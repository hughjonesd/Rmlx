...
#> Compiled closed-form ||w - w*|| = 0.09746527
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.65s |          0.0975 |
| MLX closed form            |     23.08ms |          0.0975 |
| MLX closed form (compiled) |     20.85ms |          0.0975 |
| Base R                     |     32.75ms |          0.0975 |
