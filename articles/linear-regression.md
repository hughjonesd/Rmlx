...
#> Compiled closed-form ||w - w*|| = 0.1013433
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.77s |          0.1013 |
| MLX closed form            |     44.35ms |          0.1013 |
| MLX closed form (compiled) |     45.01ms |          0.1013 |
| Base R                     |     33.05ms |          0.1013 |
