...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.979897e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001002318
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.71s |           0.001 |
| MLX closed form            |     22.05ms |           0.001 |
| MLX closed form (compiled) |     20.81ms |           0.001 |
| Base R                     |     31.19ms |           0.001 |
