...
#> Compiled closed-form ||w - w*|| = 0.09703477
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.57s |           0.097 |
| MLX closed form            |     27.92ms |           0.097 |
| MLX closed form (compiled) |     27.05ms |           0.097 |
| Base R                     |     35.41ms |           0.097 |
