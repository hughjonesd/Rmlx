...
#> Compiled closed-form ||w - w*|| = 0.09950928
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.37s |          0.0995 |
| MLX closed form            |     22.32ms |          0.0995 |
| MLX closed form (compiled) |      21.4ms |          0.0995 |
| Base R                     |     32.44ms |          0.0995 |
