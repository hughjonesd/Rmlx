...
#> Compiled closed-form ||w - w*|| = 0.09163506
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.21s |          0.0917 |
| MLX closed form            |     26.79ms |          0.0916 |
| MLX closed form (compiled) |     26.92ms |          0.0916 |
| Base R                     |     40.75ms |          0.0916 |
