...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.980783e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001049832
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        1.5s |          0.0011 |
| MLX closed form            |        20ms |          0.0010 |
| MLX closed form (compiled) |      24.6ms |          0.0010 |
| Base R                     |      32.7ms |          0.0010 |
