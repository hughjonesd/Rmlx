...
#> Compiled closed-form ||w - w*|| = 0.08146936
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.94s |          0.0815 |
| MLX closed form            |     48.64ms |          0.0815 |
| MLX closed form (compiled) |     46.45ms |          0.0815 |
| Base R                     |     33.89ms |          0.0815 |
