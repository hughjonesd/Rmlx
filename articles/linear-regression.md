...
#> Compiled closed-form ||w - w*|| = 0.1031215
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        2.1s |          0.1032 |
| MLX closed form            |      22.6ms |          0.1031 |
| MLX closed form (compiled) |        20ms |          0.1031 |
| Base R                     |      35.7ms |          0.1031 |
