...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.084551e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.00111936
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.17s |          0.0011 |
| MLX closed form            |     33.46ms |          0.0011 |
| MLX closed form (compiled) |     23.61ms |          0.0011 |
| Base R                     |     32.68ms |          0.0011 |
