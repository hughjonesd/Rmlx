...
#> Compiled closed-form ||w - w*|| = 0.1024526
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.71s |          0.1024 |
| MLX closed form            |     36.04ms |          0.1025 |
| MLX closed form (compiled) |     24.43ms |          0.1025 |
| Base R                     |     33.43ms |          0.1025 |
