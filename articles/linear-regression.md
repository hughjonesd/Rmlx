...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 5.033952e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.001083711
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.87s |          0.0011 |
| MLX closed form            |     19.49ms |          0.0011 |
| MLX closed form (compiled) |     19.64ms |          0.0011 |
| Base R                     |     31.65ms |          0.0011 |
