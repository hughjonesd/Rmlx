...
``` r
w_sgd <- train_sgd()
#> Iteration 1000 - Loss: 4.878848e-05
```
...
#> Compiled closed-form ||w - w*|| = 0.0009584276
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.32s |           0.001 |
| MLX closed form            |     21.82ms |           0.001 |
| MLX closed form (compiled) |     20.02ms |           0.001 |
| Base R                     |     32.49ms |           0.001 |
