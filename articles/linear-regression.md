...
#> Compiled closed-form ||w - w*|| = 0.09978212
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |        2.2s |          0.0998 |
| MLX closed form            |      30.1ms |          0.0998 |
| MLX closed form (compiled) |      29.4ms |          0.0998 |
| Base R                     |      35.4ms |          0.0998 |
