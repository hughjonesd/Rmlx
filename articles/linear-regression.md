...
#> Compiled closed-form ||w - w*|| = 0.08674991
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       2.66s |          0.0867 |
| MLX closed form            |     46.66ms |          0.0867 |
| MLX closed form (compiled) |     49.44ms |          0.0867 |
| Base R                     |     93.98ms |          0.0868 |
