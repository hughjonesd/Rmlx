...
#> Compiled closed-form ||w - w*|| = 0.1017686
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.82s |          0.1018 |
| MLX closed form            |     18.48ms |          0.1018 |
| MLX closed form (compiled) |     17.26ms |          0.1018 |
| Base R                     |     31.55ms |          0.1018 |
