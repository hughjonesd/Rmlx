...
#> Compiled closed-form ||w - w*|| = 0.09790929
```
...
|:---------------------------|------------:|----------------:|
| SGD                        |       1.54s |          0.0979 |
| MLX closed form            |     20.69ms |          0.0979 |
| MLX closed form (compiled) |     19.56ms |          0.0979 |
| Base R                     |     31.94ms |          0.0979 |
